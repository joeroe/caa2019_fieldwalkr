---
title: "Gorram shiny!"
subtitle: "An accessible interface for reproducible landscape archaeology with `R` and `fieldwalkr`"
...
## Why should archaeologists use `R`*?

* Reproducibility
* Eases or adds rigour to existing methods
* Enables new approaches

\* Or your preferred scientific programming environment.
...
## T-shaped and pi-shaped researchers
...
* <https://github.com/joeroe/caa2019_fieldwalkr>
* <http://joeroe.shinyapps.io/caa2019_fieldwalkr>
